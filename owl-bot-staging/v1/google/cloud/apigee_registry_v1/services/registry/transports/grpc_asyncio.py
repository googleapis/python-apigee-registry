...
class RegistryGrpcAsyncIOTransport(RegistryTransport):
    ...
    def list_api_deployment_revisions(self) -> Callable[
        ...
        if 'list_api_deployment_revisions' not in self._stubs:
            self._stubs['list_api_deployment_revisions'] = self.grpc_channel.unary_unary(
    ...
    def delete_api_deployment_revision(self) -> Callable[
        ...
        if 'delete_api_deployment_revision' not in self._stubs:
            self._stubs['delete_api_deployment_revision'] = self.grpc_channel.unary_unary(
    ...
    def get_artifact(self) -> Callable[
            ...
            Awaitable[registry_models.Artifact]]:
