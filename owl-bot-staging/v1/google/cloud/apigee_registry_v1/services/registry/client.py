...
class RegistryClient(metaclass=RegistryClientMeta):
    ...
    @staticmethod
    def api_path(project: str,location: str,api: str,) -> str:
        """Returns a fully-qualified api string."""
        return "projects/{project}/locations/{location}/apis/{api}".format(project=project, location=location, api=api, )

    @staticmethod
    def parse_api_path(path: str) -> Dict[str,str]:
        """Parses a api path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apis/(?P<api>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def api_deployment_path(project: str,location: str,api: str,deployment: str,) -> str:
        """Returns a fully-qualified api_deployment string."""
        return "projects/{project}/locations/{location}/apis/{api}/deployments/{deployment}".format(project=project, location=location, api=api, deployment=deployment, )

    @staticmethod
    def parse_api_deployment_path(path: str) -> Dict[str,str]:
        """Parses a api_deployment path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apis/(?P<api>.+?)/deployments/(?P<deployment>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def api_spec_path(project: str,location: str,api: str,version: str,spec: str,) -> str:
        """Returns a fully-qualified api_spec string."""
        return "projects/{project}/locations/{location}/apis/{api}/versions/{version}/specs/{spec}".format(project=project, location=location, api=api, version=version, spec=spec, )

    @staticmethod
    def parse_api_spec_path(path: str) -> Dict[str,str]:
        """Parses a api_spec path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apis/(?P<api>.+?)/versions/(?P<version>.+?)/specs/(?P<spec>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def api_version_path(project: str,location: str,api: str,version: str,) -> str:
        """Returns a fully-qualified api_version string."""
        return "projects/{project}/locations/{location}/apis/{api}/versions/{version}".format(project=project, location=location, api=api, version=version, )

    @staticmethod
    def parse_api_version_path(path: str) -> Dict[str,str]:
        """Parses a api_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/apis/(?P<api>.+?)/versions/(?P<version>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def artifact_path(project: str,location: str,artifact: str,) -> str:
        """Returns a fully-qualified artifact string."""
        return "projects/{project}/locations/{location}/artifacts/{artifact}".format(project=project, location=location, artifact=artifact, )

    @staticmethod
    def parse_artifact_path(path: str) -> Dict[str,str]:
        """Parses a artifact path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/artifacts/(?P<artifact>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
        ...
        if isinstance(transport, RegistryTransport):
    ...
    def get_api_spec_contents(self,
            request: Optional[Union[registry_service.GetApiSpecContentsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def tag_api_spec_revision(self,
            request: Optional[Union[registry_service.TagApiSpecRevisionRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    def list_api_spec_revisions(self,
            request: Optional[Union[registry_service.ListApiSpecRevisionsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    def delete_api_spec_revision(self,
            request: Optional[Union[registry_service.DeleteApiSpecRevisionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def list_api_deployments(self,
            request: Optional[Union[registry_service.ListApiDeploymentsRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def create_api_deployment(self,
            request: Optional[Union[registry_service.CreateApiDeploymentRequest, dict]] = None,
            *,
            parent: Optional[str] = None,
    ...
    def update_api_deployment(self,
            request: Optional[Union[registry_service.UpdateApiDeploymentRequest, dict]] = None,
            *,
            api_deployment: Optional[registry_models.ApiDeployment] = None,
            update_mask: Optional[field_mask_pb2.FieldMask] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
    ...
    def delete_api_deployment(self,
            request: Optional[Union[registry_service.DeleteApiDeploymentRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
    ...
    def tag_api_deployment_revision(self,
            request: Optional[Union[registry_service.TagApiDeploymentRevisionRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.tag_api_deployment_revision]
    ...
    def list_api_deployment_revisions(self,
            request: Optional[Union[registry_service.ListApiDeploymentRevisionsRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_api_deployment_revisions]
    ...
    def rollback_api_deployment(self,
            request: Optional[Union[registry_service.RollbackApiDeploymentRequest, dict]] = None,
            *,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
            metadata: Sequence[Tuple[str, str]] = (),
    ...
    def delete_api_deployment_revision(self,
            request: Optional[Union[registry_service.DeleteApiDeploymentRevisionRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_api_deployment_revision]
    ...
    def get_artifact_contents(self,
            request: Optional[Union[registry_service.GetArtifactContentsRequest, dict]] = None,
            *,
            name: Optional[str] = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: Union[float, object] = gapic_v1.method.DEFAULT,
