...
from .base import ProvisioningTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class ProvisioningRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_instance(self, request: provisioning_service.CreateInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[provisioning_service.CreateInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_create_instance(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_delete_instance(self, request: provisioning_service.DeleteInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[provisioning_service.DeleteInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_delete_instance(self, response: operations_pb2.Operation) -> operations_pb2.Operation:
        ...
        """
        return response
    def pre_get_instance(self, request: provisioning_service.GetInstanceRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[provisioning_service.GetInstanceRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_get_instance(self, response: provisioning_service.Instance) -> provisioning_service.Instance:
...
class ProvisioningRestTransport(ProvisioningTransport):
    """REST backend transport for Provisioning.

    The service that is used for managing the data plane
    provisioning of the Registry.
    ...
    class _CreateInstance(ProvisioningRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            pb_request = provisioning_service.CreateInstanceRequest.pb(request)
    ...
    class _DeleteInstance(ProvisioningRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            pb_request = provisioning_service.DeleteInstanceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetInstance(ProvisioningRestStub):
        def __hash__(self):
        ...
        def __call__(self,
            ...
            Returns:
                ~.provisioning_service.Instance:
                    An Instance represents the instance
                resources of the Registry. Currently,
                only one instance is allowed for each
                project.
            ...
            pb_request = provisioning_service.GetInstanceRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            # Return the response
            resp = provisioning_service.Instance()
            pb_resp = provisioning_service.Instance.pb(resp)
    ...
    class _GetLocation(ProvisioningRestStub):
        def __call__(self,
    ...
    class _ListLocations(ProvisioningRestStub):
        def __call__(self,
    ...
    class _GetIamPolicy(ProvisioningRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _SetIamPolicy(ProvisioningRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _TestIamPermissions(ProvisioningRestStub):
        def __call__(self,
            ...
            },
{
    ...
    class _CancelOperation(ProvisioningRestStub):
        def __call__(self,
    ...
    class _DeleteOperation(ProvisioningRestStub):
        def __call__(self,
    ...
    class _GetOperation(ProvisioningRestStub):
        def __call__(self,
