...
class ProvisioningClientMeta(type):
    """Metaclass for the Provisioning client.
...
class ProvisioningClient(metaclass=ProvisioningClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ProvisioningClient: The constructed client.
        """
    ...
    def transport(self) -> ProvisioningTransport:
        ...
        Returns:
            ProvisioningTransport: The transport used by the client
                instance.
        """
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, ProvisioningTransport]] = None,
        ...
        if isinstance(transport, ProvisioningTransport):
            # transport is a ProvisioningTransport instance.
    ...
    def create_instance(self,
        ...
        # in a provisioning_service.CreateInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, provisioning_service.CreateInstanceRequest):
    ...
    def delete_instance(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a provisioning_service.DeleteInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, provisioning_service.DeleteInstanceRequest):
    ...
    def get_instance(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a provisioning_service.GetInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, provisioning_service.GetInstanceRequest):
