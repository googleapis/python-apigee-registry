...
class ProvisioningAsyncClient:
    ...
    instance_path = staticmethod(ProvisioningClient.instance_path)
    parse_instance_path = staticmethod(ProvisioningClient.parse_instance_path)
    common_billing_account_path = staticmethod(ProvisioningClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(ProvisioningClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(ProvisioningClient.parse_common_organization_path)
    common_project_path = staticmethod(ProvisioningClient.common_project_path)
    parse_common_project_path = staticmethod(ProvisioningClient.parse_common_project_path)
    common_location_path = staticmethod(ProvisioningClient.common_location_path)
    parse_common_location_path = staticmethod(ProvisioningClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(ProvisioningClient).get_transport_class, type(ProvisioningClient))
    ...
    async def create_instance(self,
            request: Optional[Union[provisioning_service.CreateInstanceRequest, dict]] = None,
            *,
        ...
        Args:
            ...
            parent (:class:`str`):
                ...
                should not be set.
            instance (:class:`google.cloud.apigee_registry_v1.types.Instance`):
            ...
            instance_id (:class:`str`):
                ...
                Instance. Must be unique within scope of
                the parent resource.
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.apigee_registry_v1.types.Instance` An Instance represents the instance resources of the Registry.
                   Currently, only one instance is allowed for each
                   project.
        ...
        request = provisioning_service.CreateInstanceRequest(request)
        ...
        response = operation_async.from_gapic(
            ...
            metadata_type=provisioning_service.OperationMetadata,
        )
    ...
    async def delete_instance(self,
            request: Optional[Union[provisioning_service.DeleteInstanceRequest, dict]] = None,
            *,
        ...
        request = provisioning_service.DeleteInstanceRequest(request)
    ...
    async def get_instance(self,
        ...
        request = provisioning_service.GetInstanceRequest(request)
