...
@pytest.mark.parametrize("client_class", [
    RegistryClient, RegistryAsyncClient
])
@mock.patch.object(RegistryClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegistryClient))
@mock.patch.object(RegistryAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegistryAsyncClient))
...
def test_list_apis_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, registry_models.Api)
                   for i in results)
...
def test_list_api_versions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, registry_models.ApiVersion)
                   for i in results)
...
async def test_list_api_versions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_api_versions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_api_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_api_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_api_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_api_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiVersion(
            name='name_value',
...
def test_update_api_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_api_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiVersion(
            name='name_value',
...
def test_delete_api_version(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_api_version),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_api_specs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_api_specs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_list_api_specs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, registry_models.ApiSpec)
                   for i in results)
...
async def test_list_api_specs_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_api_specs(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_api_spec(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_api_spec),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_get_api_spec_contents(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_api_spec_contents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_api_spec(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_api_spec),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiSpec(
            name='name_value',
...
def test_update_api_spec(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_api_spec),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiSpec(
            name='name_value',
...
def test_delete_api_spec(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_api_spec),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_tag_api_spec_revision(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.tag_api_spec_revision),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiSpec(
            name='name_value',
...
async def test_list_api_spec_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_api_spec_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_rollback_api_spec(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rollback_api_spec),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiSpec(
            name='name_value',
...
def test_delete_api_spec_revision(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_api_spec_revision),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiSpec(
            name='name_value',
...
def test_list_api_deployments_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, registry_models.ApiDeployment)
                   for i in results)
...
async def test_list_api_deployments_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_api_deployments(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_get_api_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_api_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_api_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_api_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiDeployment(
            name='name_value',
...
def test_update_api_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_api_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiDeployment(
            name='name_value',
...
def test_delete_api_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_api_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_tag_api_deployment_revision(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.tag_api_deployment_revision),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiDeployment(
            name='name_value',
...
async def test_list_api_deployment_revisions_async_pager():
    ...
    with mock.patch.object(
        ...
        async_pager = await client.list_api_deployment_revisions(request={},)
        assert async_pager.next_page_token == 'abc'
        responses = []
        async for response in async_pager: # pragma: no branch
            responses.append(response)
...
def test_rollback_api_deployment(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.rollback_api_deployment),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiDeployment(
            name='name_value',
...
def test_delete_api_deployment_revision(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_api_deployment_revision),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.ApiDeployment(
            name='name_value',
...
@pytest.mark.asyncio
async def test_delete_api_deployment_revision_async(transport: str = 'grpc_asyncio', request_type=registry_service.DeleteApiDeploymentRevisionRequest):
    client = RegistryAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_artifacts_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, registry_models.Artifact)
                   for i in results)
...
def test_get_artifact_contents(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_artifact_contents),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = httpbody_pb2.HttpBody(
            content_type='content_type_value',
...
def test_replace_artifact(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.replace_artifact),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = registry_models.Artifact(
            name='name_value',
...
def test_delete_artifact(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_artifact),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = None
...
def test_list_apis_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.RegistryRestInterceptor, "post_list_apis") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_list_apis") as pre:
        ...
        req.return_value._content = registry_service.ListApisResponse.to_json(registry_service.ListApisResponse())
...
def test_list_apis_rest_bad_request(transport: str = 'rest', request_type=registry_service.ListApisRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_get_api") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_get_api") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_api_rest_bad_request(transport: str = 'rest', request_type=registry_service.GetApiRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_api_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["api"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'availability': 'availability_value', 'recommended_version': 'recommended_version_value', 'recommended_deployment': 'recommended_deployment_value', 'labels': {}, 'annotations': {}}
    request = request_type(**request_init)
...
def test_create_api_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("apiId", )) & set(("parent", "api", "apiId", )))
...
def test_create_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_create_api") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_create_api") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_api_rest_bad_request(transport: str = 'rest', request_type=registry_service.CreateApiRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_api_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "updateMask", )) & set(("api", )))
...
def test_update_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_update_api") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_update_api") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_api_rest_bad_request(transport: str = 'rest', request_type=registry_service.UpdateApiRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_api_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_delete_api") as pre:
        pre.assert_not_called()
...
def test_delete_api_rest_bad_request(transport: str = 'rest', request_type=registry_service.DeleteApiRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_api_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_list_api_versions") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_list_api_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_service.ListApiVersionsResponse.to_json(registry_service.ListApiVersionsResponse())
        ...
        client.list_api_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_api_versions_rest_bad_request(transport: str = 'rest', request_type=registry_service.ListApiVersionsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_api_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_get_api_version") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_get_api_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_models.ApiVersion.to_json(registry_models.ApiVersion())
        ...
        client.get_api_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_api_version_rest_bad_request(transport: str = 'rest', request_type=registry_service.GetApiVersionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_api_version_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/apis/sample3'}
    request_init["api_version"] = {'name': 'name_value', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 'state_value', 'labels': {}, 'annotations': {}}
    request = request_type(**request_init)
...
def test_create_api_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("apiVersionId", )) & set(("parent", "apiVersion", "apiVersionId", )))
...
def test_create_api_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_create_api_version") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_create_api_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_api_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_api_version_rest_bad_request(transport: str = 'rest', request_type=registry_service.CreateApiVersionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_api_version_rest(request_type):
    ...
    request_init["api_version"] = {'name': 'projects/sample1/locations/sample2/apis/sample3/versions/sample4', 'display_name': 'display_name_value', 'description': 'description_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'state': 'state_value', 'labels': {}, 'annotations': {}}
    request = request_type(**request_init)
...
def test_update_api_version_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "updateMask", )) & set(("apiVersion", )))
...
def test_update_api_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_update_api_version") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_update_api_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_api_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_api_version_rest_bad_request(transport: str = 'rest', request_type=registry_service.UpdateApiVersionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_api_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_delete_api_version") as pre:
        pre.assert_not_called()
        ...
        client.delete_api_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_api_version_rest_bad_request(transport: str = 'rest', request_type=registry_service.DeleteApiVersionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_api_specs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_list_api_specs") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_list_api_specs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_service.ListApiSpecsResponse.to_json(registry_service.ListApiSpecsResponse())
        ...
        client.list_api_specs(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_api_specs_rest_bad_request(transport: str = 'rest', request_type=registry_service.ListApiSpecsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_api_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_get_api_spec") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_get_api_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_models.ApiSpec.to_json(registry_models.ApiSpec())
        ...
        client.get_api_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_api_spec_rest_bad_request(transport: str = 'rest', request_type=registry_service.GetApiSpecRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_api_spec_contents_rest_required_fields(request_type=registry_service.GetApiSpecContentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_api_spec_contents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_api_spec_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_get_api_spec_contents") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_get_api_spec_contents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_api_spec_contents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_api_spec_contents_rest_bad_request(transport: str = 'rest', request_type=registry_service.GetApiSpecContentsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_api_spec_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2/apis/sample3/versions/sample4'}
    request_init["api_spec"] = {'name': 'name_value', 'filename': 'filename_value', 'description': 'description_value', 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'revision_create_time': {}, 'revision_update_time': {}, 'mime_type': 'mime_type_value', 'size_bytes': 1089, 'hash_': 'hash__value', 'source_uri': 'source_uri_value', 'contents': b'contents_blob', 'labels': {}, 'annotations': {}}
    request = request_type(**request_init)
...
def test_create_api_spec_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("apiSpecId", )) & set(("parent", "apiSpec", "apiSpecId", )))
...
def test_create_api_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_create_api_spec") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_create_api_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_api_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_api_spec_rest_bad_request(transport: str = 'rest', request_type=registry_service.CreateApiSpecRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_api_spec_rest(request_type):
    ...
    request_init["api_spec"] = {'name': 'projects/sample1/locations/sample2/apis/sample3/versions/sample4/specs/sample5', 'filename': 'filename_value', 'description': 'description_value', 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'revision_create_time': {}, 'revision_update_time': {}, 'mime_type': 'mime_type_value', 'size_bytes': 1089, 'hash_': 'hash__value', 'source_uri': 'source_uri_value', 'contents': b'contents_blob', 'labels': {}, 'annotations': {}}
    request = request_type(**request_init)
...
def test_update_api_spec_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "updateMask", )) & set(("apiSpec", )))
...
def test_update_api_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_update_api_spec") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_update_api_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_api_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_api_spec_rest_bad_request(transport: str = 'rest', request_type=registry_service.UpdateApiSpecRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_api_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_delete_api_spec") as pre:
        pre.assert_not_called()
        ...
        client.delete_api_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_api_spec_rest_bad_request(transport: str = 'rest', request_type=registry_service.DeleteApiSpecRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_tag_api_spec_revision_rest_required_fields(request_type=registry_service.TagApiSpecRevisionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).tag_api_spec_revision._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_tag_api_spec_revision_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(()) & set(("name", "tag", )))
...
def test_tag_api_spec_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_tag_api_spec_revision") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_tag_api_spec_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.tag_api_spec_revision(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_tag_api_spec_revision_rest_bad_request(transport: str = 'rest', request_type=registry_service.TagApiSpecRevisionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_api_spec_revisions_rest_required_fields(request_type=registry_service.ListApiSpecRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_api_spec_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_api_spec_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_list_api_spec_revisions") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_list_api_spec_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_service.ListApiSpecRevisionsResponse.to_json(registry_service.ListApiSpecRevisionsResponse())
        ...
        client.list_api_spec_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_api_spec_revisions_rest_bad_request(transport: str = 'rest', request_type=registry_service.ListApiSpecRevisionsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rollback_api_spec_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_rollback_api_spec") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_rollback_api_spec") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.rollback_api_spec(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_rollback_api_spec_rest_bad_request(transport: str = 'rest', request_type=registry_service.RollbackApiSpecRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_api_spec_revision_rest_required_fields(request_type=registry_service.DeleteApiSpecRevisionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_api_spec_revision._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_api_spec_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_delete_api_spec_revision") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_delete_api_spec_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_api_spec_revision(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_api_spec_revision_rest_bad_request(transport: str = 'rest', request_type=registry_service.DeleteApiSpecRevisionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_api_spec_revision_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/apis/*/versions/*/specs/*}:deleteRevision" % client.transport._host, args[1])
...
def test_list_api_deployments_rest_required_fields(request_type=registry_service.ListApiDeploymentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_api_deployments._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_api_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_list_api_deployments") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_list_api_deployments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_service.ListApiDeploymentsResponse.to_json(registry_service.ListApiDeploymentsResponse())
        ...
        client.list_api_deployments(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_api_deployments_rest_bad_request(transport: str = 'rest', request_type=registry_service.ListApiDeploymentsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_api_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_get_api_deployment") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_get_api_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_models.ApiDeployment.to_json(registry_models.ApiDeployment())
        ...
        client.get_api_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_api_deployment_rest_bad_request(transport: str = 'rest', request_type=registry_service.GetApiDeploymentRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_api_deployment_rest_required_fields(request_type=registry_service.CreateApiDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_api_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_api_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("apiDeploymentId", )) & set(("parent", "apiDeployment", "apiDeploymentId", )))
...
def test_create_api_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_create_api_deployment") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_create_api_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_api_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_api_deployment_rest_bad_request(transport: str = 'rest', request_type=registry_service.CreateApiDeploymentRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_api_deployment_rest(request_type):
    ...
    request_init["api_deployment"] = {'name': 'projects/sample1/locations/sample2/apis/sample3/deployments/sample4', 'display_name': 'display_name_value', 'description': 'description_value', 'revision_id': 'revision_id_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'revision_create_time': {}, 'revision_update_time': {}, 'api_spec_revision': 'api_spec_revision_value', 'endpoint_uri': 'endpoint_uri_value', 'external_channel_uri': 'external_channel_uri_value', 'intended_audience': 'intended_audience_value', 'access_guidance': 'access_guidance_value', 'labels': {}, 'annotations': {}}
    request = request_type(**request_init)
...
def test_update_api_deployment_rest_required_fields(request_type=registry_service.UpdateApiDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_api_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_api_deployment_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("allowMissing", "updateMask", )) & set(("apiDeployment", )))
...
def test_update_api_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_update_api_deployment") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_update_api_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_api_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_api_deployment_rest_bad_request(transport: str = 'rest', request_type=registry_service.UpdateApiDeploymentRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_api_deployment_rest_required_fields(request_type=registry_service.DeleteApiDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_api_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_api_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_delete_api_deployment") as pre:
        pre.assert_not_called()
        ...
        client.delete_api_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_api_deployment_rest_bad_request(transport: str = 'rest', request_type=registry_service.DeleteApiDeploymentRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_tag_api_deployment_revision_rest_required_fields(request_type=registry_service.TagApiDeploymentRevisionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).tag_api_deployment_revision._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_tag_api_deployment_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_tag_api_deployment_revision") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_tag_api_deployment_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.tag_api_deployment_revision(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_tag_api_deployment_revision_rest_bad_request(transport: str = 'rest', request_type=registry_service.TagApiDeploymentRevisionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_api_deployment_revisions_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = registry_service.ListApiDeploymentRevisionsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_api_deployment_revisions_rest_required_fields(request_type=registry_service.ListApiDeploymentRevisionsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_api_deployment_revisions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_api_deployment_revisions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_list_api_deployment_revisions") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_list_api_deployment_revisions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_service.ListApiDeploymentRevisionsResponse.to_json(registry_service.ListApiDeploymentRevisionsResponse())
        ...
        client.list_api_deployment_revisions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_api_deployment_revisions_rest_bad_request(transport: str = 'rest', request_type=registry_service.ListApiDeploymentRevisionsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_rollback_api_deployment_rest_required_fields(request_type=registry_service.RollbackApiDeploymentRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).rollback_api_deployment._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_rollback_api_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_rollback_api_deployment") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_rollback_api_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.rollback_api_deployment(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_rollback_api_deployment_rest_bad_request(transport: str = 'rest', request_type=registry_service.RollbackApiDeploymentRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_api_deployment_revision_rest_required_fields(request_type=registry_service.DeleteApiDeploymentRevisionRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_api_deployment_revision._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_api_deployment_revision_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_delete_api_deployment_revision") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_delete_api_deployment_revision") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_api_deployment_revision(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_api_deployment_revision_rest_bad_request(transport: str = 'rest', request_type=registry_service.DeleteApiDeploymentRevisionRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_artifacts_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_list_artifacts") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_list_artifacts") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_service.ListArtifactsResponse.to_json(registry_service.ListArtifactsResponse())
        ...
        client.list_artifacts(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_artifacts_rest_bad_request(transport: str = 'rest', request_type=registry_service.ListArtifactsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_get_artifact") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_get_artifact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = registry_models.Artifact.to_json(registry_models.Artifact())
        ...
        client.get_artifact(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_artifact_rest_bad_request(transport: str = 'rest', request_type=registry_service.GetArtifactRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_artifact_contents_rest_required_fields(request_type=registry_service.GetArtifactContentsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_artifact_contents._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_artifact_contents_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_get_artifact_contents") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_get_artifact_contents") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_artifact_contents(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_artifact_contents_rest_bad_request(transport: str = 'rest', request_type=registry_service.GetArtifactContentsRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_artifact_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'parent': 'projects/sample1/locations/sample2'}
    request_init["artifact"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'mime_type': 'mime_type_value', 'size_bytes': 1089, 'hash_': 'hash__value', 'contents': b'contents_blob'}
    request = request_type(**request_init)
...
def test_create_artifact_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("artifactId", )) & set(("parent", "artifact", "artifactId", )))
...
def test_create_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_create_artifact") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_create_artifact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_artifact(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_artifact_rest_bad_request(transport: str = 'rest', request_type=registry_service.CreateArtifactRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_replace_artifact_rest(request_type):
    ...
    request_init["artifact"] = {'name': 'projects/sample1/locations/sample2/artifacts/sample3', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'mime_type': 'mime_type_value', 'size_bytes': 1089, 'hash_': 'hash__value', 'contents': b'contents_blob'}
    request = request_type(**request_init)
...
def test_replace_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "post_replace_artifact") as post, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_replace_artifact") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.replace_artifact(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_replace_artifact_rest_bad_request(transport: str = 'rest', request_type=registry_service.ReplaceArtifactRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_artifact_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistryRestInterceptor, "pre_delete_artifact") as pre:
        pre.assert_not_called()
        ...
        client.delete_artifact(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()


def test_delete_artifact_rest_bad_request(transport: str = 'rest', request_type=registry_service.DeleteArtifactRequest):
    client = RegistryClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_registry_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.apigee_registry_v1.services.registry.transports.RegistryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_registry_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.apigee_registry_v1.services.registry.transports.RegistryTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegistryTransport()
        adc.assert_called_once()
...
def test_registry_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.RegistryGrpcTransport, transports.RegistryGrpcAsyncIOTransport])
def test_registry_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.RegistryGrpcTransport, transports.RegistryGrpcAsyncIOTransport])
def test_registry_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
def test_api_deployment_path():
    ...
    api = "winkle"
    deployment = "nautilus"
    expected = "projects/{project}/locations/{location}/apis/{api}/deployments/{deployment}".format(project=project, location=location, api=api, deployment=deployment, )
...
def test_artifact_path():
    ...
    location = "nautilus"
    artifact = "scallop"
    expected = "projects/{project}/locations/{location}/artifacts/{artifact}".format(project=project, location=location, artifact=artifact, )
